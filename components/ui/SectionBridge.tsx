...
export default function SectionBridge({ title = "New Release Fashion", subTitle = "Our Latest Fashion that can add to your dress style for especial day. Discount applies to all products without any expection!", titleButton = "See More", link } : Props) {
    return(
